(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".clinic__slider")) new swiper_core_Swiper(".clinic__slider", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
            ...
            speed: 800,
            pagination: {
                el: ".clinic__slider .swiper-pagination",
                clickable: true
            },
            navigation: {
                prevEl: ".swiper-button-prev",
        ...
        if (document.querySelector(".perfection__slider")) new swiper_core_Swiper(".perfection__slider", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
            ...
            speed: 800,
            pagination: {
                el: ".perfection__slider .swiper-pagination",
                clickable: true
            },
            navigation: {
                prevEl: ".swiper-button-prev",
    ...
    function handleScroll() {
        ...
        var GOLDEN_RATIO = .5;
        if (document.documentElement.scrollTop / scrollableHeight > GOLDEN_RATIO) scrollToTopBtn.style.display = "flex"; else scrollToTopBtn.style.display = "none";
    }
